// erros
import { MissingParamError, Unauthorized, InvalidParamError, ServerError } from '../../errors'
...
describe('Password Controller', () => {
  test('Should return 404 if password is not equal', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
...
describe('Server Controller return exceptions', () => {
  test('Should return 500 if EmailValidator throws new Error', async () => {
    const { sut, emailValidatorStub } = makeSut()
...
describe('Add User/Account Controller', () => {
...
describe('Return 200 in case of success addAccount', () => {
